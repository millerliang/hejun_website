...
nav_item +='<li><a href="salon.html"><i class="flaticon-favorites"></i> 沙龙</a></li>';
...
nav_item +='</ul>';
nav_item +='</li>';
nav_item +='<li><a href="activity.html"><i class="flaticon-chat"></i> 活动</a></li>';
...
footMenu_item +='<li><button class="btn btn-block btn-deault" onclick="salonPage()"><i class="flaticon-favorites"></i>沙龙</button></li>';
...
chat_item +='<small class="pull-right grey"><i class="fa fa-thumbs-o-up"></i> 123</small>';
chat_item +='<h4 class="media-heading grey">王小明</h4>';
chat_item +='<p>者我開員緊，深程信每絕子自育明源，為險多萬比臺身平女體，因格同稱庭克選，文不人起反配聽係笑：日是大。</p>';
chat_item +='<p class="text-muted"><small>4/23 17:23</small> <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse_1" aria-expanded="false" aria-controls="collapse_1"><i class="fa fa-comment-o"></i> 回覆<button class="btn btn-link grey" type="button"><i class="fa fa-thumbs-up"></i> 讚</button></p>';
...
chat_item +='<div class="media-left">';
chat_item +='<a href="#">';
chat_item +='<img class="media-object" src="assets/images/avatar/default_user256.png">';
chat_item +='</a>';
chat_item +='</div>';
chat_item +='<div class="media-body">';
chat_item +='<small class="pull-right grey"><i class="fa fa-thumbs-o-up"></i> 33</small>';
chat_item +='<h4 class="media-heading grey">王国军</h4>';
chat_item +='<p>家運至經，看依工投衣的改金廣理知就電，內接然不，發人樣的理近進相止中問色成、看主時幾出臺調來日人票斯識一大商現教其讀裡車是流影大口最。生為師。女告果馬的史念後華客的海</p>';
chat_item +='<p class="text-muted"><small>4/22 22:45</small> <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse_2" aria-expanded="false" aria-controls="collapse_2"><i class="fa fa-comment-o"></i> 回覆</button><button class="btn btn-link grey" type="button"><i class="fa fa-thumbs-up"></i> 讚</button></p>';
...
//chat_item +='</div>';
//chat_item +='<div class="media-body">';
//chat_item +='<span class="pull-right grey"><i class="fa fa-thumbs-o-up"></i> 55</span>';
...
chat_item +='<div class="media-left">';
chat_item +='<a href="#">';
chat_item +='<img class="media-object" src="assets/images/avatar/user_female.png">';
chat_item +='</a>';
chat_item +='</div>';
chat_item +='<div class="media-body">';
chat_item +='<small class="pull-right grey"><i class="fa fa-thumbs-o-up"></i> 9</small>';
chat_item +='<h4 class="media-heading grey">Angela baby</h4>';
chat_item +='<p>本名楊穎，出生於上海，是香港女模特兒、女演員，目前為華誼兄弟藝人、風尚國際（Style International Management）之旗下模特 ...</p>';
chat_item +='<p class="text-muted"><small>4/22 10:18</small> <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse_3" aria-expanded="false" aria-controls="collapse_3"><i class="fa fa-comment-o"></i> 回覆</button><button class="btn btn-link grey" type="button"><i class="fa fa-thumbs-up"></i> 讚</button></p>';
